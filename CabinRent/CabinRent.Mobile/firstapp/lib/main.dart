...
void main() => runApp(MultiProvider(
  providers: [
    ...
    ChangeNotifierProvider(create: (_)=> ObjectPicturesProvider())
  ],
   child: MaterialApp(
  ...
  onGenerateRoute: (settings){
    if(settings.name==ObjectListScreen.routeName){
      return MaterialPageRoute(builder: ((context)=>ObjectListScreen()));
    }
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      theme: ThemeData(
        ...
        //
        // Try running your application with "flutter run". You'll sGee the
